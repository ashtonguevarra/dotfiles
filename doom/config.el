...
;; Ashton's Config!
;; SPC h-r-r to doom sync

;; my org agenda configuration lol
(after! org
(setq
 org-todo-keywords
'((sequence
   "TODO(t)"               ;default todo
   "LEARN(s)"              ;stuff I need to study for school or want to study
   "QUIZ(q)"               ;summative asessments, quizzes
   "EXAM(e)"               ; midterm and final exams
   "CODE(c)"               ;technical asessments or coding projects
   "DEADLINE(d)"
   "HANGOUT(h)"
